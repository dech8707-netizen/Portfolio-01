...
const projects = [
  ...
  },
  {
    ...
    description: "Intractive analytics dashboard with data visualization and filtering capabilitieas.",
    image: "/Projects/Project2.avif",
    tags: ["TypeScript", "NextJS", "Supabase"],
    demoUrl: "#",
    githubUrl: "#",
  },
  {
...
const ProjectSection = () => {
  return <section id="projects" className="py-24 px-4 relative">
    <div className="container mx-auto max-w-5xl">
      ...
      <p className="text-center text-muted-foreground mb-12 mx-w-2xl mx-auto text-lg w-[70%]">
          ...
          <div key={key} className="group bg-card rounded-lg overflow-hidden shadow-xs card-hover">
            ...
            <div className="flex flex-wrap gap-2 mb-4">
              {project.tags.map((tag) =>(
                <span className="px-2 py-1 border text-sm font-medium rounded-full bg-seconday text-secondary-foreground">
                  {tag}
                </span>
              ))}
            </div>
      ...
      <div className="text-center mt-12">
        <a href="https://github.com/devika-Chaturvedi" target="_blank" className="cosmic-button w-fit flex items-center mx-auto gap-2">
